...
class PrefectureDropDownApp(App):
    def build(self):
        ...
        for prefectures in prefectures:
            btn = Button(text=prefectures, size_hint_y=None, height=44)
            btn.bind(on_release=lambda btn: self.select_prefecture(btn.text, dropdown_button))
    ...
    def select_prefecture(self, text, button):
        button.text = text
